...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ccl.vin"];
pub const PUBLIC_RS_PUB_KEY: &str = "OyU7PfJQbLKy0wysjRj8z9Lv32sGFj1Jcv+O95ZtQiY=";
...
pub const RENDEZVOUS_PORT: i32 = 2502;
pub const RELAY_PORT: i32 = 2503;
